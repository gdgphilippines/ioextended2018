...
const template = (self) => html`
  <footer class="footer">
    <img class="logo" src="/assets/images/gdgph.png">
    <div class="spacer"></div>
    <nav class="social-nav-container">
      <ul class="social-nav-list">
        <li class="social-nav">
          <a class="social-icon-anchor" href="https://www.meetup.com/gdgphilippines/">
        ...
        <li class="social-nav">
          <a class="social-icon-anchor" href="https://plus.google.com/105750470224587854845">
        ...
        <li class="social-nav">
          <a class="social-icon-anchor" href="https://twitter.com/gdgphilippines">
            <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
        ...
        <li class="social-nav">
          <a class="social-icon-anchor" href="https://facebook.com/gdgphilippines">
            <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
        ...
        <li class="social-nav">
          <a class="social-icon-anchor" href="https://www.instagram.com/gdgphilippines/">
            <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
